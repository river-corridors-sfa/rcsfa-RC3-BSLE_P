...
file_paths <- file.path("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P_XANES_Samples", file_names)
...
write.csv(final_df_samples, "../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P_XANES_Samples/xanes_example_spectra.csv")
```
...
file_paths <- file.path("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P_XANES_Reference_Compounds", file_names)
...
write.csv(final_df_standards, "../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P_XANES_Reference_Compounds/xanes_example_referencecompounds.csv", row.names=FALSE)
```
...
write.csv(final_df_lcf, "../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P_XANES_Samples/xanes_example_lcf.csv")
```