...
#Script for Processing Formularity Log Files v2
...
#####################################################
#####################################################
### Processing Formularity_Log_Processing_v2
## This processing file is only compatible with Formularity output files generated using the Hawkes_neg.ref calibration file (doi: 10.1002/lom3.10364). Formularity_Log_Processing_v1 script used a different calibration file that should only be used within Formularity for legacy reasons. 
#####################################################
#####################################################
...
Sample_Name = "StudyCode" # Sample name for output files
