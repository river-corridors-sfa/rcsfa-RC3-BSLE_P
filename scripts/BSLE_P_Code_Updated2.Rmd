...
#land cover post hoc: 
emmeans::emmeans(model, pairwise~Land_Coverage_Category,adjust="tukey") #won't run b/c no high sagebrush
```
...
#normalized by concentration of solid char; removed total P
leach.fig<-data %>%
