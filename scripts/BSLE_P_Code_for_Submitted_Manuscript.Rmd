...
NMR <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/NMR_Deconvolutions.csv") %>%
  filter(Degradation_Corrected == 'Yes')
NMR_Spikes <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/NMR_Spike_ppm.csv") 
NMR_Species_Per <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/NMR_Species_Percent.csv") 
