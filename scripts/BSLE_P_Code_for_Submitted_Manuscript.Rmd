...
2) Chemistry data that needs post-data package processing after download from BSLE Data Package v3; this was done and provided within the BSLE P Manuscript Data Package (Barnes et al, in prep):
...
BSLE P manuscript data package URL: in prep as of 7/23/2024
...
NMR <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-NMR/NMR_Deconvolutions.csv") %>%
  filter(Degradation_Corrected == 'Yes')
NMR_Spikes <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-NMR/NMR_Spike_ppm.csv") 
NMR_Species_Per <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-NMR/NMR_Species_Percent.csv") 
XANES <- read.csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/P-XANES_LCF.csv")  
XANES_spectra <- read_csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/xanes_example_spectra.csv") #this file was generated using XANES_Spectra_Merging script 
XANES_rc_spectra <- read_csv("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Reference_Compounds/xanes_example_referencecompounds.csv") #this file was generated using XANES_Spectra_Merging script 
BSLE_0013_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0013-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0013_solid", "fit", "residual", "Po_Na_AMP_std.xmu", "Pi_Fe_GoethSorb_std.xmu"))
BSLE_0007_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0007-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0007_solid", "fit", "residual", "Pi_Na_Tri_std.xmu", "Pi_Apatite_CaDefHydroxy_std.xmu", "Pi_Al_GibbSorb_std.xmu"))
BSLE_0002_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0002-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0002_solid", "fit", "residual", "Pi_Na_Tri_std.xmu", "Pi_Mg_Tri_std.xmu", "Pi_Apatite_CaDefHydroxy_std.xmu"))
BSLE_0050_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0050-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0050_solid", "fit", "residual", "Pi_Mg_Tri_std.xmu", "Pi_Ca_Tri_std.xmu", "Pi_Apatite_CaDefHydroxy_std.xmu"))
BSLE_0014_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0014-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0014_solid", "fit", "residual", "Po_Na_AMP_std.xmu", "Pi_Fe_GoethSorb_std.xmu", "Pi_Apatite_CaDefHydroxy_std.xmu"))
BSLE_0011_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0011-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0011_solid", "fit", "residual", "Pi_Mg_Tri_std.xmu", "Pi_K_Pyro_std.xmu", "Pi_Apatite_CaDefHydroxy_std.xmu"))
BSLE_0072_solid_LCF <- read.table("../data/Barnes_2024_BSLE_P_Gradient_Manuscript_Data_Package/P-XANES/P-XANES_Samples/LCF/BSLE_0072-solid_P-XANES.xmu.lcf", quote="\"", col.names = c("eV", "BSLE_0072_solid", "fit", "residual", "Pi_NH4_Mg_std.xmu", "Pi_Apatite_Carbonate_std.xmu", "Pi_Apatite_CaDefHydroxy_std.xmu"))
```
...
##PCA
```{r}
data_wide <- stoich_mean %>%
    select(-value_sd) %>%  # Remove the value_sd column
    group_by(Burn_Severity, Land_Coverage_Category, filter, variable) %>%
    pivot_wider(
        names_from = variable,
...
data <- data_wide %>%
  select(Burn_Severity, Land_Coverage_Category, filter, contains(":P")) %>%
  select(-'C:P', -'N:P', -'Na:P', -'Al:P') %>%
  mutate_if(is.character, as.factor)  # Convert character columns to factors

# Check for NAs and remove rows with NAs in numeric columns for PCA
pca_data_clean <- na.omit(data %>% select(where(is.numeric)))

# Perform PCA
pca_result <- prcomp(pca_data_clean[4:8], scale. = TRUE)  # No need to exclude columns, as only numeric columns are selected

# Create a data frame with PCA results
pca_results_df <- as.data.frame(pca_result$x)
pca_results_df <- cbind(pca_data_clean[, c("Burn_Severity", "Land_Coverage_Category", "filter")], pca_results_df)

# Plot PCA
pca_plot <- ggplot(pca_results_df, aes(x = PC1, y = PC2, color = Burn_Severity, shape = filter)) +
  geom_point(alpha = 0.7) +
  theme_minimal() +
  labs(title = "PCA of Nutrient Data",
...
ggplot(stoich_mean, aes(x = 1, y = value_mean, color = Burn_Severity, shape = Land_Coverage_Category)) +
  geom_point(size = 3) +  # Adjust point size as needed
  labs(title = "Visualization of value_mean with Burn Severity and Land Coverage",
       x = "Sample",
       y = "value_mean") +
  theme_minimal() +
  
  # Add circles around the 3 filter categories
  stat_ellipse(aes(group = filter), type = "norm", linetype = "dashed") +
  
  # Customize the colors, shapes, and theme if needed
  scale_color_manual(values = c("red", "blue", "green", "black"))  # Adjust colors for Burn_Severity categories if desired
