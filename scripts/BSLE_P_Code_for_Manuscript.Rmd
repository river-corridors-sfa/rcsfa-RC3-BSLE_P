...
Meta$Land_Coverage_Category=factor(Meta$Land_Coverage_Category)
...
#Non-molybdate reactive P filtered (leachable aqueous phase; <0.7 nominal phase) normalized to total P in solid char
...
leach.fig <- leach.fig %>%
  mutate(
    ...
    Annotation = case_when(
      ...
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Unburned" ~ "a",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Low" ~ "aaa",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Moderate" ~ "aaa",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "High" ~ "aaa",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Unburned" ~ "aaa",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Low" ~ "aaa",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Moderate" ~ "aaa"),
    x = case_when(
      ...
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Unburned" ~ "Unburned 25",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Low" ~ "Low 295-627",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Moderate" ~ "Moderate 589-757",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "High" ~ "High 589-757",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Unburned" ~ "Unburned 25",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Low" ~ "Low 308-502",
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Moderate" ~ "Moderate 512-547"),
    y = case_when(
      ...
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Unburned" ~ 14,
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Low" ~ 37,
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "Moderate" ~ 35,
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Douglas-fir Forest" & Burn_Severity == "High" ~ 46,
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Unburned" ~ 28,
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Low" ~ 47,
      variable == "Aqueous Non-Molybdate Reactive" & Land_Coverage_Category == "Sagebrush Shrubland" & Burn_Severity == "Moderate" ~ 44),
...
leach.Pnorm.conc.mbd<-ggplot(leach.fig.mbd, aes(x = Burn_Severity, y = value, fill = Land_Coverage_Category)) +
    ...
    geom_text(aes(label = Annotation, x = x, y = y), size = 4.5, fontface = "plain")+
  facet_grid(variable ~ Land_Coverage_Category)
