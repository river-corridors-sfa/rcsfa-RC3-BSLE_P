...
XANES_stacked_spectra_rc <- ggplot(XANES_spectra_rc_subset, aes(x = eV, y = value, color = as.factor(variable))) +
  ...
  geom_text(aes(x = 2190, y = 51, label = "K-Pi"), size = 5) +
  geom_text(aes(x = 2190, y = 43, label = "Mg-Pi"), size = 5) +
  geom_text(aes(x = 2190, y = 35, label = "Al-Pi"), size = 5) +
  geom_text(aes(x = 2190, y = 27, label = "Ca-Pi"), size = 5) +
  geom_text(aes(x = 2190, y = 19, label = "Na-Pi"), size = 5) +
  geom_text(aes(x = 2190, y = 11, label = "Fe-Pi"), size = 5) +
  geom_text(aes(x = 2190, y = 4, label = "Po"), size = 5)
...
LCF13<-ggplot(BSLE_0013_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "Po" = "#ae6433", "Fe-Pi" = "#87745D"),
...
pdf(file = "../figures/LCF13.pdf", width = 4, height = 3) 
print(LCF13)
dev.off()
...
LCF7<-ggplot(BSLE_0007_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "Na-Pi" = "#87745D", "Ca-Pi" = "#C5AC87", "Al-Pi" = "#F1DCA7"), 
        name = NULL  # Remove the legend title
    ) +
    scale_linetype_manual(
...
pdf(file = "../figures/LCF7.pdf", width = 4, height = 3) 
print(LCF7)
dev.off()
...
LCF2<-ggplot(BSLE_0002_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "Na-Pi" = "#87745D", "Mg-Pi" = "#C5AC87", "Ca-Pi" = "#F1DCA7"),
        name = NULL  # Remove the legend title
    ) +
    scale_linetype_manual(
...
pdf(file = "../figures/LCF2.pdf", width = 4, height = 3) 
print(LCF2)
dev.off()
...
LCF50<-ggplot(BSLE_0050_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "Mg-Pi" = "#87745D", "Ca-Pi (1)" = "#C5AC87", "Ca-Pi (2)" = "#F1DCA7"),
        name = NULL  # Remove the legend title
    ) +
    scale_linetype_manual(
...
pdf(file = "../figures/LCF50.pdf", width = 4, height = 3) 
print(LCF50)
dev.off()
...
LCF14<-ggplot(BSLE_0014_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "Po" = "#ae6433", "Fe-Pi" = "#87745D", "Ca-Pi" = "#C5AC87"),
        name = NULL  # Remove the legend title
    ) +
    scale_linetype_manual(
...
pdf(file = "../figures/LCF14.pdf", width = 4, height = 3) 
print(LCF14)
dev.off()
...
LCF11<-ggplot(BSLE_0011_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "Mg-Pi" = "#87745D", "K-Pi" = "#C5AC87", "Ca-Pi" = "#F1DCA7"),
        name = NULL  # Remove the legend title
    ) +
    scale_linetype_manual(
...
pdf(file = "../figures/LCF11.pdf", width = 4, height = 3) 
print(LCF11)
dev.off()
...
LCF72<-ggplot(BSLE_0072_solid_LCF_combined, aes(x = eV, y = value, color = component, linetype = component)) +
    geom_line() +
    scale_color_manual(
        values = c("Sample" = "black", "Fit" = "#565e60", "NH4-Pi" = "#87745D", "Ca-Pi (1)" = "#C5AC87", "Ca-Pi (2)" = "#F1DCA7"),
        name = NULL  # Remove the legend title
    ) +
    scale_linetype_manual(
...
pdf(file = "../figures/LCF72.pdf", width = 4, height = 3) 
print(LCF72)
dev.off()
